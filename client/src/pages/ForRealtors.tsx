          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                Whether you have an off-market fixer listing, know of a property that needs investors, or have a listing that's stalled on the MLS — we have a partnership model that works for you. Your clients get top dollar. You earn your commission. Reach out by form, text, or email.
              </p>
