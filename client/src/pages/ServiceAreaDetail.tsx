...
const areaData: Record<string, AreaData> = {
  ...
  "modesto": {
    name: "Modesto / Central Valley",
    county: "Stanislaus County",
    h1: "Sell Your Modesto & Central Valley House Fast — Competing Investor Offers",
    description: "The Central Valley's affordable housing market is a magnet for experienced investors. Whether you have a fixer in Modesto, Turlock, or anywhere in the Central Valley, our network is ready to compete for your property.",
    ...
    localFacts: ["Central Valley's growth attracts strong investor interest", "Our network has purchased 40+ homes in the region", "Affordable entry points mean more competing investors"],
  },
};
