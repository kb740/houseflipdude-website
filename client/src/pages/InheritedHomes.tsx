...
export default function InheritedHomes() {
  useSEO({
    ...
    description: "Inherited a Bay Area house? Get competing cash offers from investors. No repairs, no cleaning, no probate delays. Close in as little as 7 days. Call (925) 588-7804.",
  });
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link href="/contact">
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-white gap-2">
                <Phone className="w-4 h-4" /> Call Us — (925) 588-7804
              </Button>
            </Link>
            <a href="#get-offers">
            ...
            {[
              {
                ...
                desc: "Fill out the form below or call us at (925) 588-7804. We'll ask about the property condition, the probate status, and your timeline. No obligation, completely confidential."
              },
              {
                step: "2",
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Call us at <a href="tel:+19255887804" className="text-primary font-semibold hover:underline">(925) 588-7804</a>. We'll walk you through the process and answer any questions about selling your inherited home.</p>
                  </div>
                </div>
              </div>
            </div>
