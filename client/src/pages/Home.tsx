...
export default function Home() {
  useSEO({
    ...
    description: "Sell your Bay Area house fast. Multiple investors compete to buy your property — any condition, no fees, no commissions. Get competing cash offers today. Call (925) 588-7804.",
  });
