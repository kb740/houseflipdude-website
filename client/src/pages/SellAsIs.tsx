...
export default function SellAsIs() {
  useSEO({
    ...
    description: "Sell your Bay Area house as-is with zero repairs, zero fees. Multiple investors compete to buy your home in any condition. Close in as little as 7 days. Call (925) 588-7804.",
  });
            ...
            {[
              {
                ...
                desc: "Fill out the form below or call us at (925) 588-7804. Tell us about the property's condition, location, and your timeline. No judgment — we've seen everything."
              },
              {
                step: "2",
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Call us at <a href="tel:+19255887804" className="text-primary font-semibold hover:underline">(925) 588-7804</a>. We'll give you an honest assessment of whether your property is a fit for our investor network.</p>
                  </div>
                </div>
              </div>
            </div>
